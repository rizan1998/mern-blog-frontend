...
const postsData = [
  {
    ...
    createdAt: "2023-01-28T15:32:52.607+0000",
  },
  {
    _id: "2",
    image: images.Post1Image,
...
const tagsData = ["Medical", "Lifestyle", "Learn", "Healty", "Food", "Diet", "Education"];
    ...
    <MainLayout>
      <section className="container mx-auto max-w-5x1 flex flex-col px-5 py-5 lg:flex-row lg:gap-x-5 lg:items-start">
        <article className="flex-1">
          ...
          <h1 className="text-xl font-medium font-roboto my-4 text-dark-hard md:text-[26px]"> Help children get better education</h1>
          <div className="mt-4 text-dark-soft">
            <p className="leading-7">
              ...
              scelerisque. In egestas erat imperdiet sed euismod nisi porta lorem mollis. Morbi tristique senectus et netus. Mattis pellentesque id nibh tortor id aliquet lectus proin.
            </p>
          </div>
