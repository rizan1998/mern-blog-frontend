  ...
  return (
    <>
      <svg className="w-full h-auto max-h-40 translate-y-[1px]" preserveAspectRatio="none" viewBox="0 0 2160 263" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path id="Wave" d="M2160 262.5H0V0C360 80 720 120 1080 120C1440 120 1800 80 2160 0V262.5Z" fill="#0D2436" />
      </svg>
        ...
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            ...
            <div className="w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0">
              ...
              <button className="px-4 py-3 w-full bg-primary text-white font-bold rounded-lg md:w-fit md:whitespace-nowrap ">Get Started</button>
            </div>
          ...
          <div className="col-span-12 lg:col-span-6 hidden md:block md:order-first lg:order-last mb-[70px] ">
            <div className="w-3/4 mx-auto relative">
              <div
                className="w-1/2 h-1/2 bg-[#FC5A5A] rounded-lg absolute top-[10%]
              -right-[8%]"
              />
              ...
              <div className="rounded-xl w-full bg-white p-3 z-[1] relative">
                ...
                <div className="p-5">
                  <h2 className="font-roboto font-bold text-xl text-dark-soft md:text-2xl lg:text-[28px] ">Feature of Work</h2>
